...
object Helpers extends LazyLogging {
  ...
  /** Create an IOResourceConf Map for each of the given files, where the file is a key and the
    * value is the output configuration
    * @param files
    *   will be the names out the output files
    * @param configuration
    *   to provide access to the program's configuration
    * @return
    *   a map of file -> IOResourceConfig
    */
  ...
  /** Helper function to write multiple outputs
    * @param outputs
    *   map of String and relative IOResourceg
    * @return
    *   outputs itself.
    */
